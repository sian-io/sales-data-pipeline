...
1. **Data Generation**: The FastAPI service simulates sales records for the last 24 hours, returning a list of dictionaries with fields like seller, product, category, quantity, price, status, date, and time.
   ...
   > ```
2. **ETL Pipeline**: Airflow runs a DAG (`etl_sales_pipeline`) daily with three steps:
