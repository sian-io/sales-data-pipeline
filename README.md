...
1. **Data Generation**: The FastAPI service simulates sales records for the last 10 minutes, returning a list of dictionaries with fields like seller, product, category, quantity, price, status, date, and time.
